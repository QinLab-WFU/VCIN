...
TEXT_FILE = 'outputs/x_{}_ClsGen_DenseNet121_MaxView2_NumLabel114_History_Hyp.txt'.format(DATASET_NAME)
LABEL_FILE = 'outputs/x_{}_ClsGen_DenseNet121_MaxView2_NumLabel114_History_Lbl.txt'.format(DATASET_NAME)
...
if __name__ == "__main__":
    ...
    if DATASET_NAME == 'MIMIC':
        ...
        dataset = TextDataset(text_file=TEXT_FILE, label_file=LABEL_FILE, sources=SOURCES, targets=TARGETS,
                              vocab_file='./MIMIC/mimic_unigram_1000.model', max_len=1000)
        ...
        dataset = TextDataset(text_file=TEXT_FILE, label_file=LABEL_FILE, sources=SOURCES, targets=TARGETS,
                              vocab_file='./NLMCXR/nlmcxr_unigram_1000.model', max_len=1000)
...
metrics_dict = compute_metrics(hypothesis='./outputs/x_MIMIC_ClsGen_DenseNet121_MaxView2_NumLabel114_History_Hyp.txt',
                               references=['./outputs/x_MIMIC_ClsGen_DenseNet121_MaxView2_NumLabel114_History_Ref.txt'])